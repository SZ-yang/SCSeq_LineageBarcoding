...
load("~/kzlinlab/projects/scContrastiveLearn/out/kevin/Writeup10c/Writeup10c_celltag_variancePartition.RData")
...
ggplot2::ggsave(plot1,
                filename = paste0(fig_folder, "Writeup10c_celltag_variancePartition.png"),
                width = 6, height = 6)
